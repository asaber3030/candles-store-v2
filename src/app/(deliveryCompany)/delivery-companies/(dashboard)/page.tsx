import { getDeliveryCompanyOrdersStatsCount, getDeliveryTotalIncome } from "@/features/deliveryCompany/dashboard/api/dashboard.api"
  ...
  return (
    <div className='space-y-6'>
      ...
      <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        <DeliveryOrderStatsItem bgColor='bg-blue-100' textColor='text-blue-800' href='' icon={Check} num={orderStats.delivered} label={t("Delivered Orders")} />
        <DeliveryOrderStatsItem bgColor='bg-blue-100' textColor='text-blue-800' href='' icon={Check} num={orderStats.undelivered} label={t("Undelivered Orders")} />
      </section>
