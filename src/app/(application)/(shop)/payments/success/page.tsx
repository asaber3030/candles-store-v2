    ...
    return (
      <div className='min-h-screen from-background via-muted/30 to-background flex items-center justify-center p-4'>
        <div className='w-full max-w-md text-center'>
          ...
          <p className='text-base text-muted-foreground mb-6'>You have accessed this page incorrectly. Please return to the checkout page to complete your payment.</p>
          <Link href='/checkout' className='block'>
            <Button className='w-full bg-primary hover:bg-primary/90 text-primary-foreground text-base h-12 rounded-lg font-semibold'>Go to Checkout</Button>
          </Link>
        </div>
      </div>
    )
        ...
        <div className='text-center space-y-6'>
          ...
          <div className='space-y-3 pt-4'>
            <Link href='/' className='block'>
              <Button className='w-full bg-success hover:bg-success/90 text-success-foreground text-base h-12 rounded-lg font-semibold'>Back to Home</Button>
            </Link>
            <Link href='/profile/orders' className='block'>
              <Button variant='outline' className='w-full text-base h-12 rounded-lg'>
                View Orders
              </Button>
            </Link>
          </div>
