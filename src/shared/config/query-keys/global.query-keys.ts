export const queryKeys = {
  ...
  pages: {
    index: (sp: TObject = {}) => ["admin", "pages", "paginated", sp],
    all: (sp: TObject = {}) => ["admin", "pages", "all", sp],
    single: (id: number) => ["admin", "pages", id],
    pageSections: (id: number) => ["admin", "pages", id, "sections"],
  },
  countries: {
