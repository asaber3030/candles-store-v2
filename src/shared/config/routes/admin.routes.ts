export const adminRoutes = {
  ...
  changePassword: "/admin/settings/profile/update-password",
  settings: "/admin/settings",
  popupSettings: "/admin/settings/popup",
  bannerSettings: "/admin/settings/banner",
  pagesSettings: "/admin/settings/pages",
  accountSettings: "/admin/settings/profile",
  products: {
  ...
  pages: {
    index: "/admin/settings/pages",
    view: (id: number) => `/admin/settings/pages/${id}`,
  },
  orders: {
    index: "/admin/orders",
