...
function DropdownMenuTrigger({ ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.Trigger>) {
  ...
  return <DropdownMenuPrimitive.Trigger dir={locale === "ar" ? "rtl" : "ltr"} data-slot='dropdown-menu-trigger' {...props} />
}
...
function DropdownMenuLabel({
  ...
  const locale = useLocale()
  return <DropdownMenuPrimitive.Label dir={locale === "ar" ? "rtl" : "ltr"} data-slot='dropdown-menu-label' data-inset={inset} className={cn("px-2 py-1.5 text-sm font-medium data-[inset]:pl-8", className)} {...props} />
}
