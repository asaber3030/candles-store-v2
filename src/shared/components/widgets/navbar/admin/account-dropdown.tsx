  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem onClick={() => router.push(adminRoutes.profile)}>{t("Profile")}</DropdownMenuItem>
        <DropdownMenuItem onClick={() => router.push(adminRoutes.changePassword)}>{t("Change Password")}</DropdownMenuItem>
        <DropdownMenuSeparator />
