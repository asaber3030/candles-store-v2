...
import { User, MapPin, Lock, ShoppingCart, Trash2, LucideIcon, LockIcon } from "lucide-react"
...
const defaultTabs = [
  { label: "Profile", icon: User, href: deliveryRoutes.profile },
  { label: "Change Password", icon: LockIcon, href: deliveryRoutes.changePassword }
]
