      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {settings?.facebook && (
            ...
            >
              <Image
                src={SocialLogos.facebook}
                width={50}
                height={50}
                className="w-7 h-7 text-muted-foreground group-hover:text-primary-foreground transition-colors"
                alt={"Facebook"}
              />
            </a>
          )}
