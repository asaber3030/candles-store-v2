          ...
          return (
            ...
            >
              <div className='flex flex-col items-center'>
                <div
                  className={`flex items-center justify-center w-10 h-10 rounded-full transition-all duration-500 ${isCompleted || isCurrent ? (isRefusedOrCanceled ? "bg-red-200 text-red-600" : "bg-primary text-primary-foreground") : "bg-gray-200 text-gray-600"} ${
